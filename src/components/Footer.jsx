...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: Mail, text: "info@globalpath.com" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <p>
            ...
            <a href="#" className="hover:text-primary-accent ml-2">Privacy Policy</a> | 
            <a href="#" className="hover:text-primary-accent ml-2">Terms of Service</a>
          </p>
        </motion.div>
      </div>
    </motion.footer>
